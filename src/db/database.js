...
export async function seedDatabase() {
  ...
  const DEFAULT_UPC_PRODUCTS = [
    ...
    '3-Gang Faceplate',
    '4-Gang Faceplate',
    '1-Gang Faceplate (Floral)',
    '2-Gang Faceplate (Floral)',
    '3-Gang Faceplate (Floral)',
    '4-Gang Faceplate (Floral)',
    '1-Gang Faceplate (Wildflower)',
    '2-Gang Faceplate (Wildflower)',
    '3-Gang Faceplate (Wildflower)',
    '4-Gang Faceplate (Wildflower)',
    '3-Gang Faceplate (Holly)',
    '4-Gang Faceplate (Holly)',
    '3-Gang Faceplate (Mushroom)',
    '4-Gang Faceplate (Mushroom)',
    '1-Gang Faceplate (Snowman)',
    '2-Gang Faceplate (Snowman)',
    '3-Gang Faceplate (Snowman)',
    '4-Gang Faceplate (Snowman)',
    '1-Gang Faceplate (Pastel Holly)',
    '2-Gang Faceplate (Pastel Holly)',
    '3-Gang Faceplate (Pastel Holly)',
    '4-Gang Faceplate (Pastel Holly)',
    '1-Gang Faceplate (Snowflake)',
    '2-Gang Faceplate (Snowflake)',
    '3-Gang Faceplate (Snowflake)',
    '4-Gang Faceplate (Snowflake)',
